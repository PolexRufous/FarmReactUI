...
import ru from './i18n/locale.json';
...
const messages = localeData[languageWithoutRegionCode] || localeData[language] || localeData.ru;
...
ReactDOM.render(<IntlProvider locale={language} messages={messages}><Header /></IntlProvider>,header);
ReactDOM.render(<IntlProvider locale={language} messages={messages}><Main /></IntlProvider>,main);
ReactDOM.render(<IntlProvider locale={language} messages={messages}><Footer /></IntlProvider>,footer);